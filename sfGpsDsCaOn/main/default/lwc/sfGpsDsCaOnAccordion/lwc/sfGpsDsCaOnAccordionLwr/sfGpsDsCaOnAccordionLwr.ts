...
const DEBUG = false;
// eslint-disable-next-line no-unused-vars
const CLASS_NAME = "SfGpsDsCaOnAccordionLwr";

/**
 * @slot Accordion-Content
 * @description Ontario Design System Accordion Item for Experience Builder.
 */
export default class SfGpsDsCaOnAccordionLwr extends SfGpsDsLwc {
