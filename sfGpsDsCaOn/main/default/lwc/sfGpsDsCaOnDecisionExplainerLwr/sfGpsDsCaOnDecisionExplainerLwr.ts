...
const DEBUG = false;
// eslint-disable-next-line no-unused-vars
const CLASS_NAME = "SfGpsDsCaOnDecisionExplainerLwr";

/**
 * Experience Builder (Lwrunity) variant of the Decision Explainer component.
 * 
 ...
 */
export default class SfGpsDsCaOnDecisionExplainerLwr extends SfGpsDsLwc {
