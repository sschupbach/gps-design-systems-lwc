...
describe("c-sf-gps-ds-ca-on-site-selector-tool", () => {
  ...
  describe("MapSelectorMixin Integration", () => {
    ...
    it("should have getAddressData() public method", () => {
      const element = createElement("c-sf-gps-ds-ca-on-site-selector-tool", {
        is: SfGpsDsCaOnSiteSelectorTool
      });
      document.body.appendChild(element);

      expect(typeof element.getAddressData).toBe("function");
      
      const data = element.getAddressData();
    ...
    it("should inherit tab navigation from mixin", () => {
      ...
      return Promise.resolve()
        ...
        .then(() => {
          ...
          expect(tabs[1].dataset.tab).toBe("sitepoint");
    ...
    it("should use component-specific iframe selector", () => {
      ...
      return Promise.resolve()
        ...
        .then(() => {
          // SiteSelectorTool uses .sfgpsdscaon-site-selector__map-iframe
          const iframe = element.querySelector(".sfgpsdscaon-site-selector__map-iframe");
          expect(iframe).not.toBeNull();
        });
    });
  });
